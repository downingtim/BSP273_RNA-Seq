...
Differential gene expression analysis of BSP273 data - 6 infected vs 6 mock samples. This repository contains the scripts and results for a differential expression (DE) analysis of RNA-Seq data.
...
## Create the environment with the right R packages
